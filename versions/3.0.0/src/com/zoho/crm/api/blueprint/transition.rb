  ...
  module Blueprint
    class Transition
      ...
      def percent_partial_save
        ...
        # @param percent_partial_save [Integer] A Integer

      def percent_partial_save=(percent_partial_save)
        if percent_partial_save!=nil and !percent_partial_save.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: percent_partial_save EXPECTED TYPE: Integer', nil, nil)
        end
