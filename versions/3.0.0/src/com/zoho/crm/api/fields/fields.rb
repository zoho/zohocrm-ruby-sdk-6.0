  ...
  module Fields
    class Fields
      ...
      def autonumber=(autonumber)
        ...
        # The method to get the auto_number_60
        # @return An instance of AutoNumber
      ...
      def auto_number_60
        ...
        # The method to set the value to auto_number_60
        # @param auto_number_60 [AutoNumber] An instance of AutoNumber

      def auto_number_60=(auto_number_60)
        if auto_number_60!=nil and !auto_number_60.is_a? AutoNumber
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: auto_number_60 EXPECTED TYPE: AutoNumber', nil, nil)
        end
        @auto_number_60 = auto_number_60
